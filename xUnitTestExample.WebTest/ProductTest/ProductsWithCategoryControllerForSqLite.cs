...
{
    public class ProductsWithCategoryControllerForSqLite : ProductsWithCategoryControllerTest
    {
        public ProductsWithCategoryControllerForSqLite()
        {
            ...
            SetContextOptions(new DbContextOptionsBuilder<DataContext>().UseSqlite(connection).Options);
        }
